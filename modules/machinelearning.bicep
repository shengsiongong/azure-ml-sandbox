// Create machine learning workspace, private endpoints and compute resources
...
param machineLearningComputePublicIp bool

@description('VM size for the default compute cluster')
param vmSizeParam string

resource machineLearning 'Microsoft.MachineLearningServices/workspaces@2023-04-01' = {
  ...
  properties: {
    ...
    // compute cluster used to build images behind Vnet
    // https://techcommunity.microsoft.com/t5/fasttrack-for-azure/how-to-build-an-environment-when-your-azure-ml-workspace-is/ba-p/3657699
...
module machineLearningPrivateEndpoint 'machinelearningnetworking.bicep' = {
  ...
  params: {
    ...
    machineLearningWorkspaceId: machineLearning.id
    subnetId: subnetId
