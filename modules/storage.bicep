...
resource storagePrivateEndpointFile 'Microsoft.Network/privateEndpoints@2023-04-01' = {
...
resource blobPrivateDnsZoneLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
  ...
  name: '${blobPrivateDnsZoneName}-link' // uniqueString(storage.id)
  location: 'global'
  properties: {
...
resource blobPrivateEndpointDnsGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2023-04-01' = {
...
resource filePrivateEndpointDnsGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2023-04-01' = {
...
resource filePrivateDnsZoneVnetLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
  ...
  name: '${filePrivateDnsZoneName}-link' // uniqueString(storage.id)
  location: 'global'
  properties: {
    registrationEnabled: false
    virtualNetwork: {
